...
use Vipa\JournalBundle\Form\Type\SubmissionChecklistType;
...
class SubmissionChecklistController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $source = new Entity('VipaJournalBundle:SubmissionChecklist');
        ...
        $rowAction[] = $gridAction->showAction('vipa_journal_checklist_show', ['id', 'journalId' => $journal->getId()]);
        $rowAction[] = $gridAction->editAction('vipa_journal_checklist_edit', ['id', 'journalId' => $journal->getId()]);
        $rowAction[] = $gridAction->deleteAction(
            'vipa_journal_checklist_delete',
        ...
        return $grid->getGridResponse('VipaJournalBundle:SubmissionChecklist:index.html.twig');
    }
    ...
    public function sortAction(Request $request)
    {
        ...
        if($request->getMethod() == 'POST' && $request->request->has('sortData')){
            ...
            return $this->redirectToRoute('vipa_journal_checklist_sort', [
                'journalId' => $journal->getId(),
            ]);
        }

        return $this->render('VipaJournalBundle:SubmissionChecklist:sort.html.twig', [
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render(
            'VipaJournalBundle:SubmissionChecklist:new.html.twig',
            array(
                'entity' => $entity,
    ...
    private function createCreateForm(SubmissionChecklist $entity, $journalId)
    {
        ...
        $form = $this->createForm(
            ...
            $entity,
            array(
                'action' => $this->generateUrl('vipa_journal_checklist_create', ['journalId' => $journalId]),
                'languages' => $languages,
                'method' => 'POST',
            )
        );
    ...
    public function showAction(SubmissionChecklist $entity)
    {
        ...
        $token = $this
            ...
            ->refreshToken('vipa_journal_checklist'.$entity->getId());

        return $this->render(
            'VipaJournalBundle:SubmissionChecklist:show.html.twig',
            array(
                'entity' => $entity,
                'token' => $token,
            )
    ...
    public function editAction(SubmissionChecklist $entity)
    {
        ...
        return $this->render(
            'VipaJournalBundle:SubmissionChecklist:edit.html.twig',
            array(
                'entity' => $entity,
    ...
    public function deleteAction(Request $request, SubmissionChecklist $entity)
    {
        ...
        $token = $csrf->getToken('vipa_journal_checklist'.$entity->getId());
        ...
        return $this->redirectToRoute('vipa_journal_checklist_index', ['journalId' => $journal->getId()]);
    }
}
