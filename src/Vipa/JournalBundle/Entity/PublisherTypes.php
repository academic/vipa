...
class PublisherTypes extends AbstractTranslatable
{
    ...
    protected $id;
    /**
     * @Prezent\Translations(targetEntity="Vipa\JournalBundle\Entity\PublisherTypesTranslation")
     */
     ...
     * @param null $locale
     * @return mixed|null|\Vipa\JournalBundle\Entity\PublisherTypesTranslation
     */
