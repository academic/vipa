...
use Vipa\JournalBundle\Entity\JournalAnnouncementTranslation;
...
class JournalAnnouncementNormalizeCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('vipa:journal:announcement:normalize')
...
SQL;
    ...
    {
        $entity  = $this->em->getRepository('VipaJournalBundle:JournalAnnouncement')->find($announcement['id']);
