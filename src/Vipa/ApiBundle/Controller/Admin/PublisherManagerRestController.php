...
class PublisherManagerRestController extends FOSRestController
{
    ...
    public function getPublishermanagersAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('vipa_api.publisher_manager.handler')->all($limit, $offset);
    }
     ...
     *   output = "Vipa\PublisherManagerBundle\Entity\PublisherManager",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function postPublishermanagerAction(Request $request)
    {
        ...
        try {
            $newEntity = $this->container->get('vipa_api.publisher_manager.handler')->post(
                $request->request->all()
            );
            $routeOptions = array(
                'id' => $newEntity->getId(),
    ...
    public function putPublishermanagerAction(Request $request, $id)
    {
        ...
        try {
            if (!($entity = $this->container->get('vipa_api.publisher_manager.handler')->get($id))) {
                $statusCode = Codes::HTTP_CREATED;
                $entity = $this->container->get('vipa_api.publisher_manager.handler')->post(
                    $request->request->all()
                );
            } else {
                $statusCode = Codes::HTTP_NO_CONTENT;
                $entity = $this->container->get('vipa_api.publisher_manager.handler')->put(
                    $entity,
                    $request->request->all()
                );
            }
    ...
    {
        try {
            $entity = $this->container->get('vipa_api.publisher_manager.handler')->patch(
                $this->getOr404($id),
                $request->request->all()
            );
    ...
    public function deletePublishermanagerAction($id)
    {
        ...
        $this->container->get('vipa_api.publisher_manager.handler')->delete($entity);
