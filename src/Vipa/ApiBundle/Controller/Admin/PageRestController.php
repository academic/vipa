...
class PageRestController extends FOSRestController
{
    ...
    public function getPagesAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('vipa_api.page.handler')->all($limit, $offset);
    }
     ...
     *   output = "Vipa\PageBundle\Entity\Page",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function postPageAction(Request $request)
    {
        ...
        try {
            $newEntity = $this->container->get('vipa_api.page.handler')->post(
                $request->request->all()
            );
            $routeOptions = array(
                'id' => $newEntity->getId(),
    ...
    public function putPageAction(Request $request, $id)
    {
        ...
        try {
            if (!($entity = $this->container->get('vipa_api.page.handler')->get($id))) {
                $statusCode = Codes::HTTP_CREATED;
                $entity = $this->container->get('vipa_api.page.handler')->post(
                    $request->request->all()
                );
            } else {
                $statusCode = Codes::HTTP_NO_CONTENT;
                $entity = $this->container->get('vipa_api.page.handler')->put(
                    $entity,
                    $request->request->all()
                );
            }
    ...
    {
        try {
            $entity = $this->container->get('vipa_api.page.handler')->patch(
                $this->getOr404($id),
                $request->request->all()
            );
    ...
    public function deletePageAction($id)
    {
        ...
        $this->container->get('vipa_api.page.handler')->delete($entity);
