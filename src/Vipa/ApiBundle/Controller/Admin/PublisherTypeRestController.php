...
class PublisherTypeRestController extends FOSRestController
{
    ...
    public function getPublishertypesAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('vipa_api.publisher_type.handler')->all($limit, $offset);
    }
     ...
     *   output = "Vipa\PublisherTypeBundle\Entity\PublisherType",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function postPublishertypeAction(Request $request)
    {
        ...
        try {
            $newEntity = $this->container->get('vipa_api.publisher_type.handler')->post(
                $request->request->all()
            );
            $routeOptions = array(
                'id' => $newEntity->getId(),
    ...
    public function putPublishertypeAction(Request $request, $id)
    {
        ...
        try {
            if (!($entity = $this->container->get('vipa_api.publisher_type.handler')->get($id))) {
                $statusCode = Codes::HTTP_CREATED;
                $entity = $this->container->get('vipa_api.publisher_type.handler')->post(
                    $request->request->all()
                );
            } else {
                $statusCode = Codes::HTTP_NO_CONTENT;
                $entity = $this->container->get('vipa_api.publisher_type.handler')->put(
                    $entity,
                    $request->request->all()
                );
            }
    ...
    {
        try {
            $entity = $this->container->get('vipa_api.publisher_type.handler')->patch(
                $this->getOr404($id),
                $request->request->all()
            );
    ...
    public function deletePublishertypeAction($id)
    {
        ...
        $this->container->get('vipa_api.publisher_type.handler')->delete($entity);
