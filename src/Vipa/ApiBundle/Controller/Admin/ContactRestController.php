...
class ContactRestController extends FOSRestController
{
    ...
    public function getContactsAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('vipa_api.contact.handler')->all($limit, $offset);
    }
     ...
     *   output = "Vipa\ContactBundle\Entity\Contact",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function postContactAction(Request $request)
    {
        ...
        try {
            $newEntity = $this->container->get('vipa_api.contact.handler')->post(
                $request->request->all()
            );
            $routeOptions = array(
                'id' => $newEntity->getId(),
    ...
    public function putContactAction(Request $request, $id)
    {
        ...
        try {
            if (!($entity = $this->container->get('vipa_api.contact.handler')->get($id))) {
                $statusCode = Codes::HTTP_CREATED;
                $entity = $this->container->get('vipa_api.contact.handler')->post(
                    $request->request->all()
                );
            } else {
                $statusCode = Codes::HTTP_NO_CONTENT;
                $entity = $this->container->get('vipa_api.contact.handler')->put(
                    $entity,
                    $request->request->all()
                );
            }
    ...
    {
        try {
            $entity = $this->container->get('vipa_api.contact.handler')->patch(
                $this->getOr404($id),
                $request->request->all()
            );
    ...
    public function deleteContactAction($id)
    {
        ...
        $this->container->get('vipa_api.contact.handler')->delete($entity);
