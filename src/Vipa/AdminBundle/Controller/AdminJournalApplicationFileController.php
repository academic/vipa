...
use Vipa\AdminBundle\Form\Type\JournalApplicationFileType;
use Vipa\CoreBundle\Controller\VipaController as Controller;
use Vipa\JournalBundle\Entity\JournalApplicationFile;
...
class AdminJournalApplicationFileController extends Controller
{
    ...
    {
        $source = new Entity('VipaJournalBundle:JournalApplicationFile');
        $grid = $this->get('grid')->setSource($source);
        $gridAction = $this->get('grid_action');

        $actionColumn = new ActionsColumn("actions", 'actions');

        $rowAction[] = $gridAction->showAction('vipa_admin_application_file_show', 'id');
        $rowAction[] = $gridAction->editAction('vipa_admin_application_file_edit', 'id');
        $rowAction[] = $gridAction->deleteAction('vipa_admin_application_file_delete', 'id');
        ...
        return $grid->getGridResponse('VipaAdminBundle:AdminJournalApplicationFile:index.html.twig', $data);
    }
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirectToRoute('vipa_admin_application_file_show', ['id' => $entity->getId()]);
        }

        return $this->render(
            'VipaAdminBundle:AdminJournalApplicationFile:new.html.twig',
            array(
                'entity' => $entity,
    ...
    private function createCreateForm(JournalApplicationFile $entity)
    {
        ...
        $form = $this->createForm(
            ...
            $entity,
            array(
                'action' => $this->generateUrl('vipa_admin_application_file_create'),
                'method' => 'POST',
                'languages' => $languages
            )
        );
    ...
    public function showAction(JournalApplicationFile $entity)
    {
        ...
        $token = $this
            ...
            ->refreshToken('vipa_admin_application_file'.$entity->getId());

        return $this->render(
            'VipaAdminBundle:AdminJournalApplicationFile:show.html.twig',
    ...
    public function editAction(JournalApplicationFile $entity)
    {
        ...
        return $this->render(
            'VipaAdminBundle:AdminJournalApplicationFile:edit.html.twig',
            array(
                'entity' => $entity,
    ...
    private function createEditForm(JournalApplicationFile $entity)
    {
        ...
        $form = $this->createForm(
            ...
            $entity,
            array(
                'action' => $this->generateUrl('vipa_admin_application_file_update', array('id' => $entity->getId())),
                'method' => 'PUT',
                'languages' => $languages
            )
        );
    ...
    public function updateAction(Request $request, JournalApplicationFile $entity)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect(
                $this->generateUrl('vipa_admin_application_file_edit', array('id' => $entity->getId()))
            );
        }
    ...
    public function deleteAction(Request $request, JournalApplicationFile $entity)
    {
        ...
        $token = $csrf->getToken('vipa_admin_application_file'.$entity->getId());
        ...
        return $this->redirectToRoute('vipa_admin_application_file_index');
    }
}
