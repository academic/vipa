...
class JournalArticleFileRestController extends ApiController
{
     ...
     *   output = "Ojs\JournalBundle\Entity\ArticleFile",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function postFileAction(Request $request)
    {
        ...
        try {
            ...
            $newEntity = $this->container->get('ojs_api.journal_article_file.handler')->post(
                $request->request->all()
            );
            $routeOptions = array(
                'id' => $newEntity->getId(),
    ...
    public function putFileAction(Request $request, $id)
    {
        ...
        try {
            ...
            if (!($entity = $this->container->get('ojs_api.journal_article_file.handler')->get($id))) {
                ...
                $entity = $this->container->get('ojs_api.journal_article_file.handler')->post(
                    $request->request->all()
                );
            } else {
                $statusCode = Codes::HTTP_NO_CONTENT;
                $entity = $this->container->get('ojs_api.journal_article_file.handler')->put(
                    $entity,
                    $request->request->all()
                );
            }
    ...
    public function patchFileAction(Request $request, $id)
    {
        ...
        try {
            $journalService = $this->container->get('ojs.journal_service');
            $entity = $this->container->get('ojs_api.journal_article_file.handler')->patch(
                $this->getOr404($id),
                $request->request->all()
            );
            $routeOptions = array(
    ...
    public function deleteFileAction($id)
    {
        ...
        $this->container->get('ojs_api.journal_article_file.handler')->delete($entity);
