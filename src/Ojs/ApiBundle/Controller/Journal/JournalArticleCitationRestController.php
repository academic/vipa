...
class JournalArticleCitationRestController extends ApiController
{
    ...
    public function getCitationsAction(ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('ojs_api.journal_article_citation.handler')->all($limit, $offset);
    }
     ...
     *   output = "Ojs\JournalBundle\Entity\ArticleCitation",
     *   statusCodes = {
     *     200 = "Returned when successful",
    ...
    public function deleteCitationAction($id)
    {
        ...
        $entity = $this->getOr404($id);
        $this->container->get('ojs_api.journal_article_citation.handler')->delete($entity);
