...
class ArticleController extends Controller
{
    ...
    public function citationAction($id = null)
    {
        ...
        return $this->render(
            'OjsJournalBundle:Article:citation.html.twig',
            array(
                'item' => $article,
    ...
    public function indexJournalAction($journalId)
    {
        ...
        return $this->render(
            'OjsJournalBundle:Article:index_journal.html.twig',
            array(
                'entities' => $entities,
                'journal' => $journal,
            )
    ...
    public function indexIssueAction($issueId)
    {
        ...
        return $this->render(
            'OjsJournalBundle:Article:index_issue.html.twig',
            array(
                'entities' => $entities,
                'issue' => $issue,
            )
    ...
    public function showAction($id)
    {
        ...
        return $this->render(
            'OjsJournalBundle:Article:show.html.twig',
            array(
                'entity' => $entity,
            )
        );
    ...
    public function previewAction($id)
    {
        ...
        return $this->render(
            'OjsJournalBundle:Article:author_preview.html.twig',
            array(
                'entity' => $entity,
            )
        );
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            foreach ($files as $file) {
                ...
                $imagepath = $this->get('kernel')->getRootDir(
                    ).'/../web/uploads/articlefiles/'.$fileHelper->generatePath($file, false);
    ...
    public function articleNewCitationAction($id)
    {
        ...
        if (!$this->isGranted('EDIT', $articleEntity->getJournal(), 'articles') && !$this->isGranted(
                'EDIT',
                $articleEntity
            )
        ) {
