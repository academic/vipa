...
class InstitutionTypesControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $crawler = $client->request('GET', '/institution_types/');
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'ojstr_journalbundle_institutiontypestype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'ojstr_journalbundle_institutiontypestype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
