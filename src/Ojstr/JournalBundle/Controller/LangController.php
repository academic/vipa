...
use Ojstr\JournalBundle\Form\LangType;
...
class LangController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OjstrJournalBundle:Lang')->findAll();

        return $this->render('OjstrJournalBundle:Lang:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OjstrJournalBundle:Lang:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OjstrJournalBundle:Lang')->find($id);
        ...
        return $this->render('OjstrJournalBundle:Lang:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OjstrJournalBundle:Lang:edit.html.twig', array(
            'entity'      => $entity,
