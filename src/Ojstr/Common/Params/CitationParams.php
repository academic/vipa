...
class CitationParams {
    ...
    public static $CITATION_TYPE_PROCEEDINGS = "proceedings";
    public static $CITATION_TYPE_TECHREPORT = "techreport";
    public static $CITATION_TYPE_UNPUBLISHED = "unpublished";
    public static $CITATION_TYPE_INPROCEEDINGS = "inproceedings";
