...
class UserJournalRoleController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('userjournalrole_show', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(UserJournalRole $entity)
    {
        $form = $this->createForm(new UserJournalRoleType(), $entity, array(
            'action' => $this->generateUrl('userjournalrole_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new UserJournalRoleType(), $entity, array(
            'action' => $this->generateUrl('userjournalrole_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('userjournalrole_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('userjournalrole_delete', array('id' => $id)))
            ->setMethod('DELETE')
